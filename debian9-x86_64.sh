...
# This forked 0.1150 installer is intentionally fresh-install only:
...
if [ -n "$CURRENT_OMR" ] \
	...
	echo "0.1150 is fresh-install only. Reinstall the VPS from a clean Debian image before running this installer."
	exit 1
fi
# Force update key
